...
public class PlanATripViewModel extends ViewModel {
    ...
    public static final String FROM_PLACE_LABEL = "Choose starting location (Latitude, Longitude)";
    public static final String TO_PLACE_LABEL = "Choose destination (Latitude, Longitude)";
