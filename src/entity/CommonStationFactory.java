...
public class CommonStationFactory implements StationFactory {
    @Override
    public Station create(String name, String id, double longitude, double latitude, boolean accessibility, int transitMode, int distance_from_user, Route[] routes){
